package com.accedia.noto.adapters;
...
import com.accedia.noto.R;
import com.accedia.noto.api.NetworkState;
import com.accedia.noto.databinding.FeedItemBinding;
import com.accedia.noto.databinding.NetworkItemBinding;
import com.accedia.noto.helpers.AppUtils;
...
public class FeedListAdapter extends PagedListAdapter<Article, RecyclerView.ViewHolder> {
    ...
    public class ArticleItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(Article article) {
            ...
            binding.itemTime.setText(String.format(context.getString(R.string.item_date), AppUtils.getDate(article.getPublishedAt()), AppUtils.getTime(article.getPublishedAt())));
